declare module 'ts-essentials' {
	...
	export type DeepPartial<T> = T extends Primitive ? T : T extends Function ? T : T extends Date ? T : T extends Map<infer K, infer V> ? DeepPartialMap<K, V> : T extends Set<infer U> ? DeepPartialSet<U> : T extends {} ? {
	...
	export type DeepNonNullable<T> = T extends Primitive ? NonNullable<T> : T extends Function ? NonNullable<T> : T extends Date ? NonNullable<T> : T extends Map<infer K, infer V> ? NonNullableMap<K, V> : T extends Set<infer U> ? NonNullableSet<U> : T extends {} ? {
	...
	export type DeepRequired<T> = T extends Primitive ? NonNullable<T> : T extends Function ? NonNullable<T> : T extends Date ? NonNullable<T> : T extends Map<infer K, infer V> ? RequiredMap<K, V> : T extends Set<infer U> ? RequiredSet<U> : T extends {} ? {
	...
	export type DeepReadonly<T> = T extends Primitive ? T : T extends Function ? T : T extends Date ? T : T extends Map<infer K, infer V> ? ReadonlyMap<K, V> : T extends Set<infer U> ? ReadonlySet<U> : T extends {} ? {
	...
	export type DeepWritable<T> = T extends Primitive ? T : T extends Function ? T : T extends Date ? T : T extends Map<infer K, infer V> ? WritableMap<K, V> : T extends Set<infer U> ? WritableSet<U> : T extends {} ? {
